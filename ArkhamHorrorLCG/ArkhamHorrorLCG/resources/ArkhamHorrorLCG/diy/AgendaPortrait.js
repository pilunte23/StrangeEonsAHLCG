...
const CardTypes = [ 'Agenda', 'AgendaPortrait' ];
...
function createInterface( diy, editor ) {
	...
	var PortraitTabArray = layoutPortraitsWithPanels( diy, bindings, 'Portrait', 'BackPortrait', true, false, false );
...
function paintBack( g, diy, sheet ) {
	...
	drawBody( g, diy, sheet, BackBody_box, new Array( 'Rules' ) );
