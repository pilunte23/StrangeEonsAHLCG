...
function gameObject(masterSettings) {
    ...
    this.comboSlots = new Array(
        ...
        ListItem('1 Hand', @AHLCG - Slot - 1 Hand),
        ListItem('2 Hands', @AHLCG - Slot - 2 Hands),
        ListItem('1 Arcane', @AHLCG - Slot - 1 Arcane),
        ListItem('2 Arcane', @AHLCG - Slot - 2 Arcane),
    ...
    */
    ...
    this.standardEncounterList = new Array(
        ['AbyssalGifts', 8, 'abygfts', 87], ['AbyssalTribute', 8, 'abytrib', 88], ['APhantomOfTruth', 4, 'phntm', 50], ['AgentsOfAzathoth', 10, 'agtaz', 107], ['AgentsOfCthulhu', 0, 'agtcth', 0], ['AgentsOfHastur', 0, 'agthas', 1], ['AgentsOfShubNiggurath', 0, 'agtshb', 2], ['AgentsOfYig', 5, 'agtyig', 56], ['AgentsOfYogSothoth', 0, 'agtyog', 3], ['AncientEvils', 0, 'ancevl', 4], ['AnettesCoven', 10, 'anette', 108], ['ArmitagesFate', 1, 'armfat', 5], ['AtDeathsDoorstep', 10, 'atdths', 109], ['BadLuck', 1, 'badlck', 6], ['BeastThralls', 1, 'bstthrl', 33], ['BeforeTheBlackThrone', 10, 'btbt', 110], ['BeyondTheThreshold', 9, 'byndthr', 93], ['BishopsThralls', 1, 'bpthrl', 7], ['BlackStarsRise', 4, 'bsr', 52], ['BloodOnTheAltar', 1, 'bldalt', 31], ['BrotherhoodOfTheBeast', 8, 'bhdbst', 89], ['Byakhee', 4, 'byak', 48], ['CarnevaleOfHorrorsE', 3, 'carhor', 8], ['ChillingCold', 0, 'chlcld', 9], ['CityOfSins', 10, 'ctysins', 111], ['CreepingCold', 9, 'crpcld', 94], ['CultOfTheYellowSign', 4, 'cltyel', 37], ['CultOfUmordhoth', 0, 'cltumh', 10], ['ReturnToCultOfUmordhoth', 7, 'cltumhr', 81], ['CurseOfTheRougarouE', 2, 'currou', 11], ['CurtainCall', 4, 'curtncl', 38], ['DarkCult', 0, 'dkcult', 12], ['DeadlyTraps', 5, 'deadtrp', 57], ['DecayFilth', 4, 'decay', 39], ['DecayingReality', 11, 'decrea', 128], ['Delusions', 4, 'delusn', 40], ['DelusoryEvils', 11, 'delevl', 129], ['DimCarcosa', 4, 'dimcar', 55], ['DisappearanceAtTheTwilightEstate', 10, 'datte', 112], ['Dunwich', 1, 'dunwch', 32], ['EchoesOfThePast', 4, 'echoes', 46], ['EpicMultiplayer', 6, 'epicmp', 79], ['ErraticFear', 9, 'errfr', 95], ['EvilPortents', 4, 'evilpor', 41], ['Expedition', 5, 'exped', 58], ['ExtracurricularActivity', 1, 'extact', 13], ['ForgottenRuins', 5, 'fruins', 59], ['ForTheGreaterGood', 10, 'ftgg', 113], ['Ghouls', 0, 'ghouls', 14], ['GhoulsOfUmordhoth', 7, 'ghoum', 82], ['GuardiansOfTime', 5, 'guatim', 60], ['HastursEnvoys', 11, 'hasenv', 130], ['HastursGift', 4, 'hasgft', 42], ['Hauntings', 4, 'haunt', 43], ['HeartOfTheElders', 5, 'hrteld', 71], ['HideousAbominations', 1, 'hidabo', 15], ['InexorableFate', 10, 'inexft', 114], ['InhabitantsOfCarcosa', 4, 'inhcar', 49], ['InTheClutchesOfChaos', 10, 'itcoc', 115], ['KnYan', 5, 'knyan', 73], ['LockedDoors', 0, 'lckdrs', 16], ['LostInTimeAndSpace', 1, 'litas', 36], ['MaddeningDelusions', 11, 'maddel', 131], ['MusicOfTheDamned', 10, 'motd', 116], ['NaomisCrew', 1, 'naocrw', 17], ['NeuroticFear', 11, 'neufr', 132], ['Nightgaunts', 0, 'ntgnts', 18], ['PillarsOfJudgment', 5, 'piljdg', 72], ['PnakoticBrotherhood', 5, 'pnabro', 61], ['Poison', 5, 'poison', 62], ['Rainforest', 5, 'rainfst', 63], ['Rats', 0, 'rats', 19], ['RealmOfDeath', 10, 'rlmdth', 117], ['ResurgentEvils', 9, 'resevl', 96], ['ReturnToAPhantomOfTruth', 11, 'rphntm', 133], ['ReturnToBlackStarsRise', 11, 'rbsr', 134], ['ReturnToBloodOnTheAltar', 9, 'rbldalt', 97], ['ReturnToCurtainCall', 11, 'rcurtncl', 135], ['ReturnToDimCarcosa', 11, 'rdimcar', 136], ['ReturnToEchoesOfThePast', 11, 'rechoes', 137], ['ReturnToExtracurricularActivities', 9, 'rextact', 98], ['ReturnToLostInTimeAndSpace', 9, 'rtlitas', 98], ['ReturnToTheDevourerBelow', 7, 'rdevbel', 83], ['ReturnToTheEssexCountyExpress', 9, 'resxexp', 100], ['ReturnToTheGathering', 7, 'rgather', 84], ['ReturnToTheHouseAlwaysWins', 9, 'rhsewin', 101], ['ReturnToTheLastKing', 11, 'rlstkng', 138], ['ReturnToTheMidnightMasks', 7, 'rmidmsk', 85], ['ReturnToTheMiskatonicMuseum', 9, 'rmskmus', 102], ['ReturnToThePallidMask', 11, 'rpalmsk', 139], ['ReturnToTheUnspeakableOath', 11, 'runspk', 140], ['ReturnToUndimensionedAndUnseen', 9, 'rundim', 103], ['ReturnToWhereDoomAwaits', 9, 'rtwda', 104], ['SandsOfEgypt', 8, 'sdsegpt', 90], ['SecretDoors', 9, 'scrtdr', 105], ['SecretsOfTheUniverse', 10, 'sotu', 118], ['Serpents', 5, 'serpent', 64], ['ShatteredAeons', 5, 'shaaon', 76], ['SilverTwilightLodge', 10, 'siltwil', 119], ['SingleGroup', 6, 'singrp', 80], ['Sorcery', 1, 'sorcry', 20], ['SpectralPredators', 10, 'specpred', 120], ['StrikingFear', 0, 'strfr', 21], ['TemporalFlux', 5, 'temflx', 65], ['TheBayou', 2, 'bayou', 22], ['TheBeyond', 1, 'beyond', 23], ['TheBoundaryBeyond', 5, 'bndry', 70], ['TheCityOfArchives', 5, 'ctyarc', 75], // this is out of order, cuz I'm dumb
        ['TheDepthsOfYoth', 5, 'tdoy', 74], ['TheDevourerBelow', 0, 'devbel', 24], ['TheDevourersCult', 7, 'devclt', 86], ['TheDoomOfEztli', 5, 'dmeztli', 66], ['TheEssexCountyExpress', 1, 'esxexp', 25], ['TheEternalSlumber', 8, 'eslmbr', 91], ['TheFloodBelow', 4, 'flood', 53], ['TheGathering', 0, 'gather', 26], ['TheHouseAlwaysWins', 1, 'hsewin', 27], ['TheLabyrinthsOfLunacyE', 6, 'lablun', 78], ['TheLastKing', 4, 'lstkng', 44], ['TheMidnightMasks', 0, 'midmsk', 28], ['TheMiskatonicMuseum', 1, 'mskmus', 29], ['TheNightsUsurper', 8, 'ntusrpr', 92], ['ThePallidMask', 4, 'palmsk', 51], ['TheSecretName', 10, 'secrtnm', 121], ['TheStranger', 4, 'strngr', 45], ['TheUnspeakableOath', 4, 'unspk', 47], ['TheUntamedWilds', 5, 'untmdwld', 67], ['TheVortexAbove', 4, 'vortex', 54], ['TheWagesOfSin', 10, 'twos', 122], ['TheWatcher', 10, 'watcher', 123], ['TheWitchingHour', 10, 'wtchhr', 124], ['ThreadsOfFate', 5, 'tof', 69], ['TrappedSpirits', 10, 'trpspi', 125], ['TurnBackTime', 5, 'tbt', 77], ['UndimensionedAndUnseen', 1, 'undim', 34], ['UnionAndDisillusion', 10, 'undis', 126], ['WhereDoomAwaits', 1, 'wda', 35], ['Whippoorwills', 1, 'whip', 30], ['Witchcraft', 10, 'witch', 127], ['YigsVenom', 5, 'yigvnm', 68], ['YogSothothsEmissaries', 9, 'yogem', 106]
    );
