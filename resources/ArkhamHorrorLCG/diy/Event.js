...
function createFrontPainter( diy, sheet ) {
	...
	if ( $CardClass == 'Weakness' ) createTextShape( Body_box, diy.settings.getRegion( getExpandedKey( FACE_FRONT, 'WeaknessBody-region') ) );
...
function paintFront( g, diy, sheet ) {
	...
	var regionName = 'Body';
	if ( $CardClass == 'Weakness' ) regionName = 'WeaknessBody';
